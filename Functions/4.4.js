 ...
 * FUNCTIONS :
 *  
 * randNumber       Generates a random number from arg b to arg a;
 * 
 * multiRand        Generates an array from amount random numbers generated by RandNumber();
 * 
 * pickLearner      Generates an array of n elements randomly taken from inputAr;
 *
 */
...
console.log(pickLearner(becodeTrainees, randNumber((becodeTrainees.length), 1)));
